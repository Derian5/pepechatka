...
// Соответствие названий товаров и цен (точно по HTML)
    const priceMap = {
        "A4 Ч/Б, 1 сторона": 6,
        "A4 Ч/Б, 2 стороны": 8,
        "A4 цвет, 1 сторона": 10,
        "A4 цвет, 2 стороны": 18,
        "Чертёж A3, Ч/Б": 40,
        "Чертёж A3, цвет": 50,
        "Чертёж A3, заливка до 50%": 70,
        "Чертёж A3, заливка более 50%": 85,
        "Чертёж A2, Ч/Б": 60,
        "Чертёж A2, цвет": 85,
        "Чертёж A2, заливка до 50%": 140,
        "Чертёж A2, заливка более 50%": 180,
        "Чертёж A1, Ч/Б": 110,
        "Чертёж A1, цвет": 130,
        "Чертёж A1, заливка до 50%": 240,
        "Чертёж A1, заливка более 50%": 360,
        "Чертёж A0, Ч/Б": 250,
        "Чертёж A0, цвет": 300,
        "Чертёж A0, заливка до 50%": 400,
        "Чертёж A0, заливка более 50%": 500,
        "Пластик до 50 листов": 60,
        "Пластик до 80 листов": 80,
        "Пластик до 100 листов": 100,
        "Пластик до 200 страниц": 200,
        "Пластик более 200 страниц": 300,
        "Бечёвка": 30,
        "Фальц A3 > A4": 25,
        "Фальц A1/A2 > A4": 35,
        "Фальц A0 > A4": 70,
